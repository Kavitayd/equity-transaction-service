        ...
        try (InputStream inputStream = file.getInputStream(); Workbook workbook = new XSSFWorkbook(inputStream)) {
            ...
            while (rows.hasNext()) {
                ...
                try {
                    ...
                    dto.setIsin(getStringValue(row.getCell(19)));
                    dto.setSecurityName(getStringValue(row.getCell(20)));
                    dto.setListingStatus(getStringValue(row.getCell(22)));
                    dto.setPrdHoldingFlag(getStringValue(row.getCell(23)));
                    ...
                    //  Generate and set custom transaction ID
                    dto.setTransactionId(
                            ServiceUtil.generateCustomTransactionId(
                                    clientCode,
                                    dto.getEventType(),
                                    securityCode
                            )
